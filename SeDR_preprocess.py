...
def preprocess(args):
    ...
    splits_dir_lst, all_linecnt = multi_file_process(
        ...
        out_passage_path, DocumentPreprocessingFn,
        args.max_seq_length
        )
...
def DocumentPreprocessingFn(args, line, tokenizer):
    line_arr = line.split('\t')
...
def main():
    ...
    args.out_data_dir = "./data/preprocess"
